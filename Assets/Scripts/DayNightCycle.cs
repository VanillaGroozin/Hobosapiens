...
public class DayNightCycle : MonoBehaviour
{
    ...
    private void TurnLights(bool isEnable)
    {
        foreach (var lightObject in lights.GetComponentsInChildren<UnityEngine.Rendering.Universal.Light2D>())
        {
            Debug.Log(lightObject);
            lightObject.enabled = isEnable;
        }
    }
